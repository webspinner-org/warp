    ...
    () =>
      chatAndParse({
        userMessage:
          ...
          `- **EVERY entity you reference (whether as a parentEntity OR as a linkTo target) MUST have its own form-screen, list-screen, AND detail-screen.** If a transaction's "account" field links to an Account entity, then there MUST be an "Add an Account" form-screen, an "All Accounts" list-screen, and an "Account Detail" detail-screen with parentEntity="account". Reports do NOT count — a report's parentEntity must still appear as a real entity with its own form/list/detail trio.\n` +
