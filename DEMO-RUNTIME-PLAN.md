...
| -------- | ------------------------------------------------- | --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **R0**   | Demo Cell infrastructure                          | **not started** | Two launchd plists (Grimoire-demo on :8091, Loom-demo on :3010) + bootstrap creds at `~/.warp/bootstrap-demo/` + demo Cell identity key + demo PB data directory. Boot once, idempotent.                                                                                                                                                                                                                                                                                                                                                           |
