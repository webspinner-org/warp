...
| -------- | ------------------------------------------------- | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **R0**   | Demo Cell infrastructure                          | **done (2026-05-16)** | `tools/demo-cell-up` ran on Kepler. Grimoire-demo on :8091, Loom-demo on :3010 (initially tried :3001, conflicted with com.webspinner.uptime-kuma — see OPEN_QUESTIONS 2026-05-16 _Kepler platform engineering_). Bootstrap creds at `~/.warp/bootstrap-demo/`. Demo Cell identity key fingerprint: `d9abadc887096bd7` (distinct from operator's `4d243e2e40d9986b`). Both services bootstrapped via launchd, smoke-passed (`/admin → 303` Loom-identity probe). Idempotent.                                                                       |
